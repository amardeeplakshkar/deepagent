...
- package: `@deepagent/searxng`
- exports: `class SearxngClient`, `namespace searxng`
- env vars: `SEARXNG_API_BASE_URL`
- [source](https://github.com/amardeeplakshkar/deepagent/blob/main/packages/searxng/src/searxng-client.ts)
...
{`
\`\`\`bash npm
npm install @deepagent/searxng
\`\`\`

\`\`\`bash yarn
yarn add @deepagent/searxng
\`\`\`

\`\`\`bash pnpm
pnpm add @deepagent/searxng
\`\`\`
`}
</PackageTabs>
