...
import { Features } from "@/src/components/blocks/features-8"
import GlitchEffect from '@/src/components/ui/glitch-effect'
import { MarqueeDemo } from '@/src/components/core/Marquee'
import Link from 'next/link'
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/src/components/ui/tabs'
import OpenAI from '@/src/components/icons/open-ai'
import Anthropic from '@/src/components/icons/anthropic'
import Gemini from '@/src/components/icons/gemini'
import { DynamicCodeBlock } from 'fumadocs-ui/components/dynamic-codeblock'
import { DeepAgentAnimatedBeam } from '@/src/components/core/AnimatedBeam'
    ...
    <>
      <div className='max-w-7xl mx-auto w-full border m-2 flex items-center justify-center flex-col gap-4'>
        ...
        <div className='mt-8 md:mt-16 gap-3 lg:mt-20 p-4 ibm-plex-mono-bold uppercase flex flex-wrap justify-center text-center'>
          <h2 className='text-3xl md:text-3xl lg:text-5xl whitespace-normal break-words'>
            Tools That Works <br className='m-2' />  with any 
            <GlitchEffect
              words={["LLM"]}
              interval={3000}
              className="ml-2 text-3xl md:text-3xl lg:text-5xl  text-background px-2 bg-foreground"
